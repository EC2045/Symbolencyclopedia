    ...
    symbols: [
      {
        ...
        example: '本当にそれが最善の選択だったのか:句点和疑問符:',
      ...
      },
      {
        ...
        example: 'なるほど、そういうことでしたか:句点和感嘆符:\n長年の謎がようやく解けました。',
        createdAt: nowStamp(), updatedAt: nowStamp()
      },
      {
      ...
      },
      {
        ...
        example: '本日は貴重なお時間をいただき、本当にありがとうございました:感嘆謝符:',
        createdAt: nowStamp(), updatedAt: nowStamp()
      },
      {
      ...
      },
      {
        ...
        example: 'みんな必死に言い争ってるけど、結局どっちもどっちだよね:俯瞰符:',
        createdAt: nowStamp(), updatedAt: nowStamp()
      },
      {
      ...
      },
      {
        ...
        example: 'この件に関する議論はこれで終了とする:ハイパーピリオド:\n以降の異議申し立ては一切受け付けない。',
        createdAt: nowStamp(), updatedAt: nowStamp()
      },
      {
